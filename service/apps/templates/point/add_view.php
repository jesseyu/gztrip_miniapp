    ...
    <form method='post' action='<?= URL('point/addpoint'); ?>' class='pageForm required-validate' enctype="multipart/form-data" onsubmit="return iframeCallback(this);">
        <div class='pageFormContent nowrap' layoutH='97'>
            ...
            <dl>
                <dt>坐标：</dt>
                <dd>
                    <input type='text' name='coordination' maxlength='255'/>
                    <span class='info'></span>
                </dd>
            </dl>
            <dl>
            ...
            <dl>
                ...
                <dd>
                    <div class='unit'>
                        <textarea class='editor' name='des' rows='10' cols='50' tools='simple'></textarea>
                    </div>
                    <span class='info'></span>
                </dd>
            </dl>
            <dl>
                <dt>分数：</dt>
                <dd>
                    <input type='text' name='score' maxlength='255'/>
                    <span class='info'></span>
                </dd>
            </dl>
            <dl>
            ...
            <dl>
                <dt>电话：</dt>
                <dd>
                    <input type='text' name='phone' maxlength='11' class='required'/>
                    <span class='info'></span>
                </dd>
            </dl>
            <dl>
